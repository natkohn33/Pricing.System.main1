...
<>
  {verificationResults.map((location, index) => (
  <div
    key={index}
    className="relative group/item p-4 bg-yellow-50 border border-yellow-200 rounded-xl hover:bg-yellow-100 transition-all cursor-pointer"
    onClick={() => handleScrollToResult(index)}
  >
    <div className="flex items-start justify-between">
      <div>
