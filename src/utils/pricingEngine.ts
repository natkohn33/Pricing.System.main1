...
export class PricingEngine {
  ...
  private determineRegion(city: string, state: string): string | null {
    ...
    // STX cities
    const stxCities = ['houston', 'corpus christi', 'conroe', 'pearland', 'league city', 'sugar land', 'baytown', 'beaumont', 'missouri city', 'galveston', 'conroe', 'texas city', 'huntsville', 'lufkin', 'tyler', 'longview', 'texarkana', 'port arthur', 'orange', 'liberty', 'cleveland', 'dayton', 'tomball', 'jersey village', 'cypress', 'humble', 'katy', 'spring', 'channelview', 'la porte'];
